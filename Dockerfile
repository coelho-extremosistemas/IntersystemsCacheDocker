...
# $ docker build --force-rm --no-cache -t cache:2017.1 .
#--
...
MAINTAINER Marcio Jota Coelho <coelho@extremosistemas.com.br>
...
ENV ISC_PACKAGE_INSTALLDIR="/InterSystems/cache"
...
RUN yum -y update && \
    ...
    wget -O - 'http://gercon.consistem.com.br/implantacao/InterSystems/2017/cache-2017.2.0.744.0-lnxrhx64.tar.gz' \
...
WORKDIR /
ADD ccontainermain .
ENTRYPOINT  ["/cconstrol start cache"]
